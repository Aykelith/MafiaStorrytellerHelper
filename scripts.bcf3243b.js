...
function (_React$Component) {
  ...
  function WelcomePage() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(WelcomePage).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        onClick: function onClick() {
          _this.props.parent.state.gameStep = GAME_STEP.GAME_SETUP;

          _this.props.parent.setState(_this.props.parent.state);
        }
      }, "Start"), React.createElement("button", {
        id: "generatorBtn",
        onClick: function onClick() {}
      }, "Generator"), React.createElement("div", {
        id: "browserStackCnt"
        ...
        src: "imgs/Browserstack-logo.svg"
      }))));
    }
  }]);
...
function (_React$Component2) {
  ...
  function GameSetupPage() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(GameSetupPage).apply(this, arguments));
  }
...
function (_React$Component3) {
  ...
  function PlayersSetupPage(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(PlayersSetupPage).call(this, props));

    if (window.debugMode) {
      _this3.props.parent.state.players = [{
        name: "Mafia 1",
        role: "Mafia",
        alive: true
      }, {
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        onChange: function onChange(e) {
          ...
          if (value == 0) {
            _this4.props.parent.state.players = [];
            return;
          }

          _this4.props.parent.state.players.length = value;

          for (var i = 0, length = _this4.props.parent.state.players.length; i < length; ++i) {
            if (!_this4.props.parent.state.players[i]) {
              _this4.props.parent.state.players[i] = Object.assign({}, DEFAULT_PLAYER);
            }
          }
        ...
        return React.createElement("tr", {
          ...
          value: player.name,
          onChange: function onChange(e) {
            _this4.props.parent.state.players[index].name = e.target.value;
          ...
          value: player.role,
          onChange: function onChange(e) {
            _this4.props.parent.state.players[index].role = e.target.value;

            if (e.target.value == "Doctor") {
              _this4.props.parent.state.players[index].timesSavedHimself = 0;
            }

            if (e.target.value == "Veteran") {
              _this4.props.parent.state.players[index].timesUsedBullet = 0;
            }
        ...
        onClick: function onClick() {
          _this4.props.parent.state.gameStep = GAME_STEP.NIGHT;
          console.log(_this4.props.parent.state.players);
...
function (_React$Component4) {
  ...
  function NightPage(props) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(NightPage).call(this, props));
    _this5.state = {};
    _this5.calculateNight = _this5.calculateNight.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.renderPlayer = _this5.renderPlayer.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.renderDay = _this5.renderDay.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.renderNight = _this5.renderNight.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.renderSelectable = _this5.renderSelectable.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.renderVeteran = _this5.renderVeteran.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.wasProtectedByDoctor = _this5.wasProtectedByDoctor.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.wasSelfDefence = _this5.wasSelfDefence.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.isGuilty = _this5.isGuilty.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.getRoleIndex = _this5.getRoleIndex.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.getNameIndex = _this5.getNameIndex.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.getRoleAlive = _this5.getRoleAlive.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.countSpecial = _this5.countSpecial.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.resetBetweenRounds = _this5.resetBetweenRounds.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.prepareForNextNight = _this5.prepareForNextNight.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.getResultMessage = _this5.getResultMessage.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    return _this5;
  }
  ...
  _createClass(NightPage, [{
    ...
    value: function renderPlayer(player, settings) {
      return React.createElement("div", {
        ...
        className: "".concat(player.role, " ").concat(settings.className || "")
    ...
    value: function getResultMessage(round, result, className) {
      ...
      if (round == NIGHT_ROUND.Veteran) {
        ...
        for (var i = 0, length = this.props.parent.state.night.veteranKills.length; i < length; ++i) {
          message += "<b>".concat(this.props.parent.state.players[this.props.parent.state.night.veteranKills[i]].name, "(").concat(PLAYER_ROLES[this.props.parent.state.players[this.props.parent.state.night.veteranKills[i]].role].text, ")</b>,");
        }

        if (this.props.parent.state.night.policeVeteranSelected) {
          ++count;
          message += "<b>".concat(this.props.parent.state.players[this.props.parent.state.night.policeVeteranSelected].name, "(").concat(PLAYER_ROLES[this.props.parent.state.players[this.props.parent.state.night.policeVeteranSelected].role].text, ")</b>,");
        }

        if (this.props.parent.state.night.doctorVeteranSelected) {
          ++count;
          message += "<b>".concat(this.props.parent.state.players[this.props.parent.state.night.doctorVeteranSelected].name, "(").concat(PLAYER_ROLES[this.props.parent.state.players[this.props.parent.state.night.doctorVeteranSelected].role].text, ")</b>,");
        }
      ...
      if (round == NIGHT_ROUND.Doctor) {
        ...
        for (var roundName in this.props.parent.state.night) {
          ...
          if (_typeof(_result) == 'object' && _result && _result.action == ROUND_ACTION.SAVED_BY_DOCTOR) {
            return React.createElement("div", {
              className: className
    ...
    value: function renderDay() {
      ...
      return React.createElement("div", {
        ...
        var index2 = _this6.getNameIndex(player.name);

        return _this6.renderPlayer(player, {
          className: "".concat(_this6.state.selectedPlayer == index2 ? "selected" : "", " ").concat(!player.alive ? "deleted" : ""),
          onClick: function onClick() {
            if (!player.alive) return;
            _this6.state.selectedPlayer = _this6.state.selectedPlayer == index2 ? null : index2;
        ...
        id: "startNightBtn",
        onClick: function onClick(e) {
          _this6.props.parent.state.night = {
            townSelected: _this6.state.selectedPlayer
          };

          if (_this6.state.selectedPlayer) {
            _this6.props.parent.state.players[_this6.state.selectedPlayer].alive = false;

            if (_this6.props.parent.state.players[_this6.state.selectedPlayer].role == "Clown") {
              _this6.state.vampireMode = true;
            }
          }

          _this6.state.selectedPlayer = null;
          _this6.state.auxSelected = null;
          _this6.state.auxActivated = false;
          _this6.state.auxUnique = false;
          _this6.state.veteranButton = null;
          _this6.props.parent.state.isNight = true;
          ++_this6.props.parent.state.dayNumber;
          _this6.props.parent.state.nightCurrentState = _this6.props.parent.state.nightOrder[0];
          _this6.props.parent.state.nightCurrentOrderIndex = 0;

          if (_this6.getRoleIndex("Godfather") == null) {
            _this6.state.auxActivated = true;
          }

          _this6.props.parent.setState(_this6.props.parent.state, function () {
            window.scrollTo(0, 0);
          });

          console.log("PLAYERS", _this6.props.parent.state.players);
        }
      }, "Incepe noaptea"));
    }
  }, {
    ...
    value: function renderSelectable(settings) {
      ...
      return React.createElement("div", {
        ...
        return !NIGHT_ROUND._roleIsForThisRound(_this7.props.parent.state.nightCurrentState, player.role) && player.alive;
      }).sort(settings.filter ? settings.filter : function (player1, player2) {
        return player1.role > player2.role;
      }).map(function (player, index) {
        var index2 = _this7.getNameIndex(player.name);

        return _this7.renderPlayer(player, Object.assign({
          className: settings.className ? "".concat(_this7.state.selectedPlayer == index2 ? "selected" : "", " ").concat(settings.className(player, index2)) : _this7.state.selectedPlayer == index2 && "selected",
          onClick: function onClick() {
            if (settings.playersLength == 0) return;
            _this7.state.selectedPlayer = _this7.state.selectedPlayer == index2 ? null : index2;
            if (_this7.state.auxUnique) _this7.state.auxSelected = null;
    ...
    value: function renderVeteran() {
      ...
      return React.createElement("div", {
        ...
        onClick: function onClick() {
          _this8.props.parent.state.night.veteranSelected = _this8.getRoleIndex('Veteran');
          _this8.state.veteranButton = 1;
        ...
        onClick: function onClick() {
          _this8.props.parent.state.night.veteranSelected = null;
          _this8.state.veteranButton = 2;
        ...
        return _this8.renderPlayer(player, {
          className: _this8.props.parent.state.night.policeVeteranSelected == index2 && "selected",
          onClick: function onClick() {
            _this8.props.parent.state.night.policeVeteranSelected = _this8.props.parent.state.night.policeVeteranSelected == index2 ? null : index2;
        ...
        return _this8.renderPlayer(player, _this8.props.parent.state.night.doctorVeteranSelected == index2 && "selected", function () {
          _this8.props.parent.state.night.doctorVeteranSelected = _this8.props.parent.state.night.doctorVeteranSelected == index2 ? null : index2;
    ...
    value: function renderNight() {
      ...
      return React.createElement("div", {
        ...
        return _this9.renderPlayer(player, {
          className: _this9.state.auxActivated && _this9.state.auxSelected == index2 && "selected",
          onClick: function onClick() {
            _this9.state.auxSelected = _this9.state.auxSelected == index2 ? null : index2;
            if (_this9.state.auxUnique) _this9.state.selectedPlayer = null;
        ...
        player: {
          role: function role(player) {
            return "".concat(roleIsInnocent(player.role) ? "Inocent" : "Vinovant", " (").concat(PLAYER_ROLES[player.role].text, ")");
          }
        },
        playersLength: currentRoundPlayers.length
        ...
        id: "backState",
        onClick: function onClick() {
          _this9.resetBetweenRounds();

          --_this9.props.parent.state.nightCurrentOrderIndex;

          if (_this9.props.parent.state.nightCurrentOrderIndex == -1) {
            _this9.props.parent.state.isNight = false;
            --_this9.props.parent.state.dayNumber;
            _this9.props.parent.state.night = Object.assign({}, _this9.props.parent.state.lastNight);
          } else {
            _this9.prepareForNextNight();
          }

          _this9.props.parent.setState(_this9.props.parent.state, function () {
            window.scrollTo(0, 0);
          });
        }
        ...
        id: "nextState",
        onClick: function onClick() {
          if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Mafia) {
            if (currentRoundPlayers.length > 0 && _this9.state.selectedPlayer == null) {
              return alert("Selecteaza un jucator");
            }

            if (currentRoundPlayers.length > 0 && _this9.getRoleIndex("Godfather") == null) {
              if (_this9.state.auxSelected == null) return alert("Selecteaza noul Godfather");else {
                _this9.props.parent.state.players[_this9.state.auxSelected].role = "Godfather";
              }
            }

            _this9.props.parent.state.night.mafiaSelected = _this9.state.selectedPlayer;
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Serialkiller) {
            if (currentRoundPlayers.length > 0 && _this9.state.selectedPlayer == null) {
              return alert("Selecteaza un jucator");
            }

            _this9.props.parent.state.night.serialkillerSelected = _this9.state.selectedPlayer;
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Police) {
            if (currentRoundPlayers.length > 0 && _this9.state.selectedPlayer == null) {
              return alert("Selecteaza un jucator");
            }

            _this9.props.parent.state.night.policeSelected = _this9.state.selectedPlayer;
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Vigilante) {
            _this9.props.parent.state.night.vigilanteSelected = _this9.state.selectedPlayer;
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Veteran) {
            if (currentRoundPlayers.length > 0) {
              if (!_this9.state.veteranButton || _this9.props.parent.state.night.veteranSelected === undefined) {
                return alert("Selecteaza DA sau NU");
              }

              if (_this9.props.parent.state.night.veteranSelected) {
                if (_this9.props.parent.state.night.policeSelected == _this9.props.parent.state.night.veteranSelected && _this9.getRoleAlive(NIGHT_ROUND.Police).length > 1 && !_this9.props.parent.state.night.policeVeteranSelected) {
                  return alert("Selecteaza un politist");
                }

                if (_this9.props.parent.state.night.doctorSelected == _this9.props.parent.state.night.veteranSelected && _this9.getRoleAlive(NIGHT_ROUND.Doctor).length > 1 && !_this9.props.parent.state.night.doctorVeteranSelected) {
                  return alert("Selecteaza un doctor");
                }

                console.log("police", _this9.props.parent.state.night.policeVeteranSelected);
              }
            }
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Doctor) {
            if (currentRoundPlayers.length > 0 && _this9.state.selectedPlayer == null && _this9.state.auxSelected == null) {
              return alert("Selecteaza un jucator");
            }

            _this9.props.parent.state.night.doctorSelected = _this9.state.selectedPlayer || _this9.state.auxSelected;
          } else if (_this9.props.parent.state.nightCurrentState == NIGHT_ROUND.Clown) {
            if (_this9.state.selectedPlayer == null) {
              return alert("Selecteaza un jucator");
            }

            _this9.props.parent.state.night.clownSelected = _this9.state.selectedPlayer;
            _this9.state.vampireMode = false;
            console.log("CLOOOWN");
          }
          ...
          if (_this9.props.parent.state.nightCurrentOrderIndex >= _this9.props.parent.state.nightOrder.length) {
            if (_this9.state.vampireMode) {
              _this9.prepareForNextNight(true);
            } else {
              _this9.calculateNight();

              _this9.props.parent.state.lastNight = Object.assign({}, _this9.props.parent.state.night);
              _this9.props.parent.state.isNight = false;

              _this9.props.parent.createHash();
            }
          } else {
            _this9.prepareForNextNight();
          }
...
function (_React$Component5) {
  ...
  function GeneratorPage(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(GeneratorPage).call(this, props));
  }
...
function (_React$Component6) {
  ...
  function MainPage(props) {
    ...
    _this10 = _possibleConstructorReturn(this, _getPrototypeOf(MainPage).call(this, props));
    _this10.state = {
    ...
    _this10.createHash = _this10.createHash.bind(_assertThisInitialized(_assertThisInitialized(_this10)));
    return _this10;
  }
    ...
    value: function componentDidMount() {
      ...
      if (window.location.hash) {
        window.packCompresser.decompress(window.location.hash).then(function (json) {
          Object.assign(_this11.state, json);
          _this11.state.lastNight = Object.assign({}, _this11.state.night);
          _this11.state.gameStep = GAME_STEP.NIGHT;
