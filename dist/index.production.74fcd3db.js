...
var WelcomePage = function (_React$Component) {
    ...
    _createClass(WelcomePage, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { id: "welcomePage", className: "main" }, React.createElement("h1", null, "Mafia Storyteller Helper"), React.createElement("h2", null, "Created by Aykelith@NiAl"), React.createElement("button", {
                id: "startBtn",
...
var GameSetupPage = function (_React$Component2) {
    ...
    _createClass(GameSetupPage, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { id: "gameSetupPage", className: "main" }, React.createElement("h2", null, "Game Setup"), React.createElement("div", { className: "block" }, React.createElement("div", null, "Ordinea noptilor:"), React.createElement("div", { id: "nightsOrderCnt" }, this.props.parent.state.nightOrder.map(function (round) {
                return React.createElement("div", { key: "round" + round }, React.createElement("span", null, NIGHT_ROUND._toText2(round)), React.createElement("div", null));
...
var PlayersSetupPage = function (_React$Component3) {
    ...
    _createClass(PlayersSetupPage, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { id: "playersSetupPage", className: "main" }, React.createElement("h2", null, "Players setup"), React.createElement("div", null, React.createElement("span", null, "Numarul de jucatori: "), React.createElement("input", {
                type: "number",
                ...
                return React.createElement("tr", { key: "player" + index }, React.createElement("td", null, index), React.createElement("td", null, React.createElement("input", {
                    type: "text",
                    value: player.name,
                    onChange: function onChange(e) {
                    ...
                    return React.createElement("option", { key: role, value: role }, PLAYER_ROLES[role].text);
...
var NightPage = function (_React$Component4) {
    ...
    _createClass(NightPage, [{
        ...
        value: function renderPlayer(player, settings) {
            return React.createElement("div", { onClick: settings.onClick, className: player.role + " " + (settings.className || "") }, React.createElement("div", null, player.name, " ", window.debugMode && React.createElement("span", null, "(", this.getNameIndex(player.name), ")")), React.createElement("div", null, settings.role ? settings.role(player) : PLAYER_ROLES[player.role].text));
        }
    }, {
        ...
        value: function getResultMessage(round, result, className) {
            ...
            if (result == null) {
                ...
                if (round == NIGHT_ROUND.Vigilante) {
                    return React.createElement("div", { className: className }, React.createElement("span", null, "Vigilentul a ales sa nu omoare"));
                }

                if (round == NIGHT_ROUND.Veteran) {
                    return React.createElement("div", { className: className }, React.createElement("span", null, "Veteranul a ales sa nu-si foloseasca glontul"));
                }
            ...
            if (round == NIGHT_ROUND.Veteran) {
                ...
                return React.createElement("div", { className: className }, count > 0 ? React.createElement("span", { dangerouslySetInnerHTML: { __html: message } }) : "Veteranul si-a folosit glontul dar nu a omorat pe nimeni!");
            }
            ...
            if (round == NIGHT_ROUND.Doctor) {
                ...
                for (var roundName in this.props.parent.state.night) {
                    ...
                    if ((typeof _result === "undefined" ? "undefined" : _typeof(_result)) == 'object' && _result && _result.action == ROUND_ACTION.SAVED_BY_DOCTOR) {
                        return React.createElement("div", { className: className }, React.createElement("span", null, "Doctorii au salvat pe cine trebuia! (", person, ")"));
                    }
                }

                return React.createElement("div", { className: className }, React.createElement("span", null, "Doctorii nu au salvat pe cine trebuia! (", person, ")"));
            }

            if (round == NIGHT_ROUND.Police) {
                return React.createElement("div", { className: className }, React.createElement("span", null, "Politistii au ales si a iesit ", result.police == ROUND_ACTION.GUILTY ? "necurat" : "curat", " (", React.createElement("b", null, this.props.parent.state.players[result.id].name, "(", PLAYER_ROLES[this.props.parent.state.players[result.id].role].text, ")"), ")"));
            }

            if (result.action == ROUND_ACTION.KILLED_IN_NIGHT) {
                return React.createElement("div", { className: className }, React.createElement("span", null, NIGHT_ROUND._toText2(round), " au omorat pe ", React.createElement("b", null, this.props.parent.state.players[result.id].name, "(", PLAYER_ROLES[this.props.parent.state.players[result.id].role].text, ")")));
            } else if (result.action == ROUND_ACTION.SAVED_BY_DOCTOR || result.action == ROUND_ACTION.SELF_DEFENCE) {
                return React.createElement("div", { className: className }, React.createElement("span", null, NIGHT_ROUND._toText2(round), " nu au reusit sa omoare pe nimeni (", React.createElement("b", null, this.props.parent.state.players[result.id].name, "(", PLAYER_ROLES[this.props.parent.state.players[result.id].role].text, ")"), ")"));
            }

            if (result.action == ROUND_ACTION.NOTHING) {
                return React.createElement("div", { className: className }, React.createElement("span", null, NIGHT_ROUND._toText2(round), " nu au omorat pe nimeni (", React.createElement("b", null, this.props.parent.state.players[result.id].name, "(", PLAYER_ROLES[this.props.parent.state.players[result.id].role].text, ")"), ")"));
            }
        ...
        value: function renderSelectable(settings) {
            ...
            return React.createElement("div", { id: "mafiaStep", className: "nightStep" }, React.createElement("div", { className: "playersStatusCnt" }, React.createElement("h3", null, settings.title), React.createElement("h4", null, settings.subtitle), this.props.parent.state.players.filter(function (player) {
        ...
        value: function renderVeteran() {
            ...
            return React.createElement("div", { id: "veteranStep", className: "nightStep" }, React.createElement("h3", null, "Vrei sa folosesti glontul?"), React.createElement("div", { id: "buttonsCnt" }, React.createElement("button", {
            ...
            }, "Nu")), this.props.parent.state.night.veteranSelected && this.props.parent.state.night.policeSelected == this.props.parent.state.night.veteranSelected && this.getRoleAlive(NIGHT_ROUND.Police).length > 1 && React.createElement("div", { className: "playersStatusCnt" }, React.createElement("h3", null, "Lista politisti"), React.createElement("h4", null, "(selecteaza un politist pentru a-l omori)"), this.getRoleAlive(NIGHT_ROUND.Police).map(function (player, index) {
            ...
            })), this.props.parent.state.night.veteranSelected && this.props.parent.state.night.doctorSelected == this.props.parent.state.night.veteranSelected && this.getRoleAlive(NIGHT_ROUND.Doctor).length > 1 && React.createElement("div", { className: "playersStatusCnt" }, React.createElement("h3", null, "Lista doctori"), React.createElement("h4", null, "(selecteaza un doctor pentru a-l omori)"), this.getRoleAlive(NIGHT_ROUND.Doctor).map(function (player, index) {
                var index2 = _this10.getNameIndex(player.name);
        ...
        value: function renderNight() {
            ...
            return React.createElement("div", { id: "nightPage_night", className: "main" }, React.createElement("h1", null, NIGHT_ROUND._toRoundText(this.props.parent.state.nightCurrentState)), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Doctor && React.createElement("div", { className: "specialCnt" }, "Medicii s-or salvat pe ei de ", this.countSpecial("timesSavedHimself"), " ori"), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Veteran && React.createElement("div", { className: "specialCnt" }, "Veteranul o folosit glontul de ", this.countSpecial("timesUsedBullet"), " ori"), React.createElement("div", { className: "playersStatusCnt" }, React.createElement("h3", null, "Lista jucatori"), currentRoundPlayers.map(function (player, index) {
            ...
            })), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Mafia && this.renderSelectable({ title: "Posibile victime", subtitle: "(selecteaza o victima)", playersLength: currentRoundPlayers.length }), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Serialkiller && this.renderSelectable({ title: "Posibile victime", subtitle: "(selecteaza o victima)", playersLength: currentRoundPlayers.length }), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Police && this.renderSelectable({
            ...
            }), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Vigilante && this.renderSelectable({ title: "Posibile victime", subtitle: "(selecteaza o victima sau nu)", playersLength: currentRoundPlayers.length }), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Doctor && this.renderSelectable({ title: "Posibile victime", subtitle: "(selecteaza o victima sau nu)", playersLength: currentRoundPlayers.length }), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Veteran && currentRoundPlayers.length > 0 && this.renderVeteran(), this.props.parent.state.nightCurrentState == NIGHT_ROUND.Clown && this.renderSelectable({ title: "Posibile victime", subtitle: "(selecteaza o victima)", playersLength: 1 }), React.createElement("div", { id: "buttonsCnt" }, React.createElement("button", {
                id: "backState",
                onClick: function onClick() {
...
var GeneratorPage = function (_React$Component5) {
    ...
    _createClass(GeneratorPage, [{
        key: "render",
        value: function render() {
            React.createElement("div", { id: "generatorPage", className: "main" }, React.createElement("h2", null, "Generator"), React.createElement("div", { id: "presetCnt" }, React.createElement("div", { id: "presetSelectCnt" }, React.createElement("span", null, "Preset:"))));
        }
    }]);
...
//# sourceMappingURL=/index.production.74fcd3db.map